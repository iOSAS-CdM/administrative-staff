				...
				<AnimatePresence mode='popLayout'>
					...
					>
						<Card>
							...
							{/* Show validation error for cover below the upload area */}
							{(() => {
								const errors = form.getFieldError('cover');
								const touched = form.isFieldTouched('cover');
								if ((touched || errors.length > 0) && errors.length > 0) {
									return (
